...
|---|---|---|
| [`crawlora`](skills/crawlora) | Umbrella catalog skill — fetch structured data from **any** of the 445 Crawlora endpoints; teaches auth, credits, and the full catalog. | all 38 |
