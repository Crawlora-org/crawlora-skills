...
|---|---|---|
| [`crawlora`](skills/crawlora) | Umbrella catalog skill — fetch structured public data from **2,955** Crawlora MCP tools; teaches auth, credits, and the public-data catalog. | 415 public-data platform groups |
