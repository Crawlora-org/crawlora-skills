...
route_method_regexes=(
  '^GET:/datasets/sec-companies/facets$'
  '^GET:/datasets/sec-companies/financials/[^/]+$'
  '^GET:/datasets/sec-companies/insider/[^/]+$'
  '^GET:/datasets/sec-companies/items/[^/]+$'
  '^GET:/datasets/sec-companies/search$'
  '^GET:/datasets/sec-institutional-positions/facets$'
  '^GET:/datasets/sec-institutional-positions/search$'
...
if [ "$route_method_allowed" = false ]; then
  echo "method is not allowed for this sec-filings-research route" >&2
  exit 2
fi
