...
One API key gives you **733 endpoints across 61 platform groups** — search engines,
...
See [`reference/catalog.md`](reference/catalog.md) for the full list of all 733
