...
One API key gives you **728 endpoints across 60 platform groups** — search engines,
...
See [`reference/catalog.md`](reference/catalog.md) for the full list of all 728
