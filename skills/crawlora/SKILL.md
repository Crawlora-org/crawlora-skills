...
One API key gives you **795 endpoints across 68 platform groups** — search engines,
...
See [`reference/catalog.md`](reference/catalog.md) for the full list of all 795
