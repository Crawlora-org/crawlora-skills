...
route_method_regexes=(
  '^GET:/brand/retrieve$'
  '^GET:/datasets/techstack/facets$'
  '^GET:/datasets/techstack/items/[^/]+$'
  '^GET:/datasets/techstack/search$'
  '^POST:/web/scrape$'
  '^POST:/web/techstack$'
)
...
if [ "$route_method_allowed" = false ]; then
  echo "method is not allowed for this techstack-prospecting route" >&2
  exit 2
fi
